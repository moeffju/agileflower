( function () {
    ...
    function ircMap(options) {
        ...
        //     if (len > 10)
        //         $messageContainer.find('li:lt(' + (len - 10) + ')').remove()
        ...
        function initWebsocketConnection() {
            ...
            server.onmessage = function(msg) {
                ...
                var location = JSON.parse(data.zip_code).results[0].geometry.location;

                console.log ("FEED: " + location.lat);
                px = latLngToPx(location.lat, location.lng);
                console.log("PX Loc: " + px);
                
                location.name = "Test User";
